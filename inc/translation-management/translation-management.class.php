...
class TranslationManagement{
        ...
        if($translation_id){
            ...
            if($translation_status < ICL_TM_COMPLETE){
                echo '<div class="error fade"><p id="icl_side_by_site">'. 
                    sprintf(__('<strong>Warning:</strong> You are trying to edit a translation that is currently in the process of being added.' , 'sitepress')) . '<br /><br />'.
    ...
    */
    ...
    public static function icanlocalize_service_info($info = array()) {
        ...
        $return['description'] = "<p>" . __('Meet freelance professional translators from around the world.<br />You can interview and choose the best ones for your project.', 'sitepress') . "</p>";
        $return['description'] .= "<p>" .  sprintf(__('%s is not affiliated with ICanLocalize.', 'sitepress'),WP_I18N_DISPLAY_NAME) . "</p>";
