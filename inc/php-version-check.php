...
function icl_dump_phpinfo(){
  ...
  if(version_compare(phpversion(), '5', '<')){
      ...
      function icl_php_version_warn(){
          ...
          echo sprintf(__('%s cannot be activated because your version of PHP is too old. To run correctly, you must have PHP5 installed.<br /> We recommend that you contact your hosting company and request them to switch you to PHP5.', 'sitepress'),WP_I18N_DISPLAY_NAME);
