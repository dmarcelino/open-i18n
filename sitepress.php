...
Description: Multilingual/internationalization plugin for WP.  Fork of WPML.
Version: 2.0.4.2-alpha
*/
...
define('ICL_SITEPRESS_VERSION', '2.0.4.1b');
define('ICL_PLUGIN_PATH', dirname(__FILE__));
define('ICL_PLUGIN_FOLDER', basename(ICL_PLUGIN_PATH));

// Some constants to use instead of sprinkling the plugin name as a string like in WPML
define('ICL_PLUGIN_SHORT_NAME','WPML');
define('WP_I18N_SHORT_NAME','WP_i82n');
define('WP_I18N_DISPLAY_NAME','WP-i82n');
define('WP_I18N_URI','http://wordpress.org/extend/plugins/wp-i18n');
define('WP_I18N_URI_SUPPORT','http://wordpress.org/extend/plugins/wp-i18n');
define('WP_I18N_FEED','');
