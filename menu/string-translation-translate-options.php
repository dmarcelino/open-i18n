...
<div class="wrap">
    ...
    <p><?php _e('This table shows all the admin texts that were found.', 'sitepress'); ?></p>
    ...
    <p><?php printf(__("Choose the fields you'd like to translate and click on the 'Apply' button. Then, use <a%s>String translation</a> to translate them.", 'sitepress'),' href="admin.php?page='.ICL_PLUGIN_FOLDER.'/menu/string-translation.php&context=admin_options_'.get_option('template').'"'); ?></p>    
