<?php
    if(!is_plugin_active(basename(dirname(dirname(__FILE__))) . "/sitepress.php")){
        ?>
        <h2><?php echo __('Setup', 'sitepress') ?></h2>
        <div class="updated fade">
        <p style="line-height:1.5"><?php echo __('The plugin is not currently enabled.', 'sitepress');?></p>
        <p style="line-height:1.5"><?php printf(__('Please go to the <a href="%s">Plugins</a> page and enable the %s plugin before trying to configure the plugin.', 'sitepress'), 'plugins.php', WP_I18N_DISPLAY_NAME);?></p>
        </div>
        <?php
        return;
    }
...
<div class="wrap">
    ...
    <div id="icl_setup_wizard_wrap">
        <h3><?php sprintf(_e('Before you can start using %s, it needs to be set up', 'sitepress'),WP_I18N_DISPLAY_NAME); ?></h3>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="icl_error_text" style="display:none;margin:10px;"><?php echo __('
                                            ...
                                            ', 'sitepress')?>                            
                                            <p>
                                                <?php printf(__('When %s accesses <a target="_blank" href="%s">%s</a> it gets:', 'sitepress'), WP_I18N_DISPLAY_NAME, $__url = get_option('home').'/' . $sample_lang['code'] .'/?____icl_validate_domain=1', $__url); ?>
                                                <br />
                                                <?php 
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            foreach($swidgets as $k=>$v){
                                                if(!empty($v) && in_array('language-selector', $v)){
                                                    $sb = $k;
