...
<div class="wrap">
        ...
        <p><?php printf(__('%s makes it possible to run full multilingual websites with WordPress. You are using <b>%s %s</b>.', 'sitepress'), WP_I18N_DISPLAY_NAME, WP_I18N_DISPLAY_NAME, ICL_SITEPRESS_VERSION)?></p>
        ...
        <table class="widefat">
            ...
            <tbody>
                    ...
                    <td>
                        <p>
                            ...
                            switch($sitepress_settings['theme_localization_type']){
                                case '1': echo sprintf(__('Translate the theme by %s', 'sitepress'),WP_I18N_DISPLAY_NAME); break;
                ...
                <tr>
                    ...
                    <td>
                        <?php _e('We can translate comments that visitors leave you in languages that you don\'t speak and translate back your replies.','sitepress') ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p><?php _e('We will send the documents that need translation to ICanLocalize and then create the translated posts and pages.','sitepress'); ?></p>
        ...
        <table class="widefat">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <p><?php echo __('With Sticky Links, all links on posts and pages are kept up-to-date, should their URL change.', 'sitepress'); ?></p>
        ...
        <br />
        <p><?php echo(sprintf(__('For advanced access or to completely uninstall this plugin and remove all language information, use the <a href="%s">troubleshooting</a> page.','sitepress'),'admin.php?page='.basename(ICL_PLUGIN_PATH).'/menu/troubleshooting.php')); ?></p>
