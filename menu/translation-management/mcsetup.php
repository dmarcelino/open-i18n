...
?>
            ...
            <tr>
                <td style="border: none;">
                    <ul>
                        ...
                        <?php /* <li><label><input type="radio" name="t_method" value="<?php echo ICL_TM_TMETHOD_PRO ?>" <?php if($doc_translation_method==ICL_TM_TMETHOD_PRO): ?>checked="checked"<?php endif; ?> /> 
    ...
    <div class="updated below-h2">
        <p style="line-height: 14px"><?php printf(__("%s can read a configuration file that tells it what needs translation in themes and plugins. The file is named wpml-config.xml and it's placed in the root folder of the plugin or theme.", 'sitepress'), WP_I18N_DISPLAY_NAME); ?></p>
