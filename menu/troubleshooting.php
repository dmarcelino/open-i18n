...
<div class="wrap">
    ...
    */
    echo '<a href="#wpml-settings">'.sprintf(__('%s Settings', 'sitepress'),WP_I18N_DISPLAY_NAME).'</a>';
    ...
    */
    ...
    echo '<br /><hr /><h3 id="wpml-settings"> ' . sprintf(__('%s Settings', 'sitepress'),WP_I18N_DISPLAY_NAME) . '</h3>';
    ...
    <small style="margin-left:10px;">Removes entries from tables that are not linked properly. Cleans the table off entries left over upgrades, bug fixes or undetermined factors.</small>
    </p>
    ...
    echo '<p class="error" style="padding:6px;">' . __("All translations you have sent to ICanLocalize will be lost if you reset plugin data. They cannot be recovered later.", 'sitepress') 
        . '</p>';
    ...
    echo '<input id="reset-all-but" type="submit" disabled="disabled" class="button-primary" value="'.__('Reset all language data and deactivate plugin', 'sitepress').'" />';    
    echo '</form>';
    ?>
    </div>
