...
<div class="wrap">
    ...
    <p class="error fade" style="padding:10px;"><?php _e('Compatibility packages will soon be obsolete and removed. Please use other means to make your site multilingual-ready.', 'sitepress')?></p>
