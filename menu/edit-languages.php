...
?>
    ...
    <p>
        ...
        <span class="hidden"><?php _e('All language information will be reset to its default values. Any languages that you added or edited will be lost.','sitepress')?></span>
    </p>
