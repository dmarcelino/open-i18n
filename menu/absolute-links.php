...
<div class="wrap">
    ...
    <p><?php echo __('Internal links to posts and pages can be turned into sticky links. What this means is that links to pages and posts will automatically update if their URL changes. There are many reasons why page URL changes:', 'sitepress'); ?></p>
    ...
    <ul>
        ...
        <li>
            ...
            &nbsp;<?php _e("Turn links in string Translation to Sticky", 'sitepress')?></label>
        </li>
    </ul>
    <p>
