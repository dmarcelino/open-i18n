...
<div class="wrap">
    ...
    <?php else: ?>
        ...
        <p><strong><?php _e('Note: Support for ICanLocalize with this plugin may be dropped soon.') ?></strong></p>
                ...
                <div class="postbox-container" style="width: 49%;">
                    <div id="normal-sortables-stsel" class="meta-box-sortables ui-sortable">
                        <div id="dashboard_wpml_stsel_1" class="postbox">
                            ...
                            <div class="inside">
                                <p class="sub"><?php echo __("Keep track of where strings are used on the public pages. Activating this feature will enable the 'view in page' functionality and make translation easier.", 'sitepress')?></p>
                        ...
                        <div id="dashboard_wpml_stsel_2" class="postbox">
                            ...
                            <div class="inside">
                                <p class="sub"><?php echo __('Translate texts entered in different admin screens. Select which texts to translate.', 'sitepress')?></p>
