    ...
    function _connect(&$fp)
    {
        ...
        else
        {
            ...
            switch($errno)
            {
                ...
                default:
                    $this->error = sprintf(__('%s cannot connect to <a%s>www.icanlocalize.com</a>. Please make sure that outgoing communication on port 80 (or 443) is enabled.
<a%s>www.icanlocalize.com</a> is found on IP - %s. You can open all ports to and from that IP.', 'sitepress'), WP_I18N_DISPLAY_NAME, ' href="http://www.icanlocalize.com/"', ' href="http://www.icanlocalize.com/"', '72.249.85.19');
            }
            return false;
        }
    }
